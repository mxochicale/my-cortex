...
see Figure~\ref{fig:pretty_function} and \ref{fig:ugly_function}.
%
\begin{figure}[h!]
    \begin{centering}
...
\begin{figure}[h!]
    \begin{centering}
    \includegraphics[width=0.5\linewidth]{figures/ugly_function.pdf}
    \oscaption{ugly_function}{%
        This is a plot of a pretty function. And at the end of this
        caption is a symbol with a link to the \emph{exact} script
        that generated it, hosted on \textsf{GitHub}.
        \label{fig:ugly_function}
    }
    \end{centering}
\end{figure}
%
